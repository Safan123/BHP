...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent('''Przyklady:
            ...
            netcat.py -t 192.168.1.108 -p 5555 -l -e=\"cat /etc/passwd\" # wykonywanie polecenia
            echo 'ABCDEF' | ./netcat.py -t 192.168.1.108 -p 135 # wyslanie tesktu do portu 135
            netcat.py -t 192.168.1.108 -p 5555 # polaczenie z serwerem
        '''))
    ...
    parser.add_argument('-t', '--target', default='192.168.237.128', help='docelowy adres ip')
